...
$sql = 'SELECT * FROM fan_favorite_books WHERE user_id=? AND is_public = 1 AND (publish_at IS NULL OR publish_at <= NOW()) ORDER BY sort_order DESC' . ($isAdminLte ? ' LIMIT 20' : '');
